...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li><a href="awal.php"><i class="notika-icon notika-star"></i> Visualiasi</a>
                        </li>
    ...
    <div class="data-table-area" >
        ...
        <?php
            ...
            $_SESSION['jaro'] = $tres_jr;
            $_SESSION['levenshtein'] = $tres_levenshtein;
            ...
            if (@$tres_levenshtein[$b]<= $treshold){   
             $tr_lv++; 
             }elseif ($tres_jr[$b]<= $treshold){   
             $tr_jr++;        
            }else{
            $nt++;      
    }
