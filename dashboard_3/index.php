        ...
        <div class="container-fluid">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-5 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Integrasi Data</h1>
              <p class="mb-4 mb-md-5 sub-p" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Review Operator Telekomunikasi Berbasis Web</p>
              <p><a href="../awal.php" class="btn btn-primary p-3 px-xl-5 py-xl-3">Visualisasi</a> 
              <!-- <a href="#" class="btn btn-primary btn-primary-2 p-3 px-xl-5 py-xl-3">Read more</a></p> -->
            </div>
            <div class="col-md-7 ftco-animate">
            	<img src="../img/laptop1.jpg" class="img-fluid" alt="">
            </div>
      ...
      <div class="slider-item" style="background-image: url(images/bg_2.jpg);">
        ...
        <div class="container-fluid">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-5 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Integrasi Data</h1>
              <p class="mb-4 mb-md-5">Review Operator Telekomunikasi Berbasis Web</p>
              <p><a href="../awal.php" class="btn btn-primary p-3 px-xl-5 py-xl-3">Visualisasi</a> 
              <!-- <a href="#" class="btn btn-primary btn-primary-2 p-3 px-xl-5 py-xl-3">Read more</a></p> -->
            </div>
            <div class="col-md-7 ftco-animate">
            	<img src="../img/laptop2.jpg" class="img-fluid" alt="">
            </div>
