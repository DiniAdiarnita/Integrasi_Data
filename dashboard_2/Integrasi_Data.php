            ...
            <section class="hero-section hero-section--slider clearfix">
                <div class="hero-section__wrap">
                    ...
                    <div class="hero-section__option" data-init="slick" data-arrows="false" data-dots="true" data-fade="false" data-autoplay="5000" data-speed="3000">
                        <img src="../img/laptop1.jpg" alt="Hero section image">
                        <img src="../img/laptop2.jpg" alt="Hero section image">
                        <img src="../img/laptop3.jpg" alt="Hero section image">
                        <img src="../img/laptop4.jpg" alt="Hero section image">
                    </div>
                        ...
                        <div class="row">
                            <div class="offset-lg-2 col-lg-8">
                                <div class="title-01 title-01--11 text-center">
                                    <h2 class="title__heading">Integrasi Data</h2>
                                    <div class="title__description">Review Operator Telekomunikasi Berbasis Web</div>

                                    <!-- Options btn color: .btn-success | .btn-info | .btn-warning | .btn-danger | .btn-primary -->
                                    <div class="title__action"><a href="../awal.php" class="btn btn-success">Visualisasi</a></div>                                </div>
                                <!-- .title-01 -->
                            </div>
                        </div>
                    </div>
