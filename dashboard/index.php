...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="../awal.php">INTEGRASI DATA</a>
      ...
      <div class="container-fluid">
        <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
          ...
          <div class="one-forth ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
          	<h1 class="mb-4"> Integrasi Data
              <strong class="typewrite" data-period="4000" data-type='[ "Twitter", "Facebook", "Operator", "Komunikasi" ]'>
                <span class="wrap"></span>
              </strong>
            </h1>
            <p class="mb-md-5 mb-sm-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Review Operator Telekomunikasi Berbasis Web</p>
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
              <a href="../awal.php" class="btn btn-primary px-4 py-3">Visualisasi</a>
             <!-- <a href="../awal.php" class="btn btn-primary btn-outline-primary px-4 py-3">Our Portfolio</a></p> -->
          </div>
          <div class="one-half align-self-md-end align-self-sm-center">
          	<div class="slider-carousel owl-carousel">
          		<div class="item">
			          <img src="../img/laptop1.jpg" class="img-fluid img"alt="">
		          </div>
		          <div class="item">
			          <img src="../img/laptop2.jpg" class="img-fluid img"alt="">
		          </div>
		          <div class="item">
			          <img src="../img/laptop3.jpg" class="img-fluid img"alt="">
		          </div>
	          </div>
          </div>
        </div>
